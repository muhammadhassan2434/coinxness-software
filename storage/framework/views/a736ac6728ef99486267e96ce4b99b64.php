...
<head>
    ...
    <style>
        .hero-section {
            background: url('<?php echo e(asset('img/banner2.jpg')); ?>') no-repeat center center;
...
<body>
    ...
    <section id="about" class="section-padding">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('img/first.png')); ?>" alt="About Us" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="vision" class="section-padding vision-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="<?php echo e(asset('img/secornd.png')); ?>" alt="Our Vision" class="img-fluid">
                </div>
                <div class="col-lg-6">
                    <h2>Our Vision</h2>
